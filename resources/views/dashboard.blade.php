                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ Vite::asset('resources/img/product-1.jpg') }}"
                                                        alt=""></a></th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ Vite::asset('resources/img/product-2.jpg') }}"
                                                        alt=""></a></th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ Vite::asset('resources/img/product-3.jpg') }}"
                                                        alt=""></a></th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ Vite::asset('resources/img/product-4.jpg') }}"
                                                        alt=""></a></th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ Vite::asset('resources/img/product-5.jpg') }}"
                                                        alt=""></a></th>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="news">
                            <div class="post-item clearfix">
                                <img src="{{ Vite::asset('resources/img/news-1.jpg') }}" alt="">
                                <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                                <p>Sit recusandae non aspernatur laboriosam. Quia enim eligendi sed ut harum...</p>
                            </div>

                            <div class="post-item clearfix">
                                <img src="{{ Vite::asset('resources/img/news-2.jpg') }}" alt="">
                            ...
                            <div class="post-item clearfix">
                                <img src="{{ Vite::asset('resources/img/news-3.jpg') }}" alt="">
                            ...
                            <div class="post-item clearfix">
                                <img src="{{ Vite::asset('resources/img/news-4.jpg') }}" alt="">
                            ...
                            <div class="post-item clearfix">
                                <img src="{{ Vite::asset('resources/img/news-5.jpg') }}" alt="">
